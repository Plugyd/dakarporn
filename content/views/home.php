<div class="page">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <div class="rd-navbar-brand"><a class="brand" href="index.html">
                                        <div class="brand__name"><img class="brand__logo-dark"
                                                src="images/logo-243x57.png" alt="" width="243" height="57" /><img
                                                class="brand__logo-light" src="images/logo-inverse-243x57.png" alt=""
                                                width="243" height="57" />
                                        </div>
                                    </a></div>
                            </div>
                            ...
                            <div class="rd-navbar-nav-wrap">
                                <div class="rd-navbar-element">
                                    <ul class="list-icons list-inline-sm">
                                        ...
                                        <li><a class="icon icon-sm fa fa-telegram icon-style-camera"
                                ...
                                <ul class="rd-navbar-nav">
                                    ...
                                    <li><a href="about-me.html">Videos</a>
                                    </li>
                                    <li><a href="typography.html">Photos</a>
                                    </li>
                                    <li><a href="contact-me.html">Comics</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <section class="section bg-white text-center">
            ...
            <div class="slick-wrap">
                <div class="slick-slider slick-style-1" data-arrows="true" data-autoplay="false" data-loop="true"
                    data-dots="true" data-swipe="true" data-xs-swipe="true" data-sm-swipe="false" data-items="1"
                    data-sm-items="3" data-md-items="3" data-lg-items="3" data-center-mode="true"
                    data-lightgallery="group-slick">




                    <div class="item slick-slide slick-current slick-active slick-center" data-slick-index="0"
                        ...
                        <div class="slick-slide-inner">
                            <div class="slick-slide-caption"><a class="thumb-ann thumb-mixed_large"
                                    href="images/kdAdetL_QBk.jpg" data-lightgallery="item" tabindex="0"><img
                                        class="thumb-ann__image"
                                        src="images/kdAdetL_QBk.jpg" alt=""
...
// todo videos for category
                ...
                <div class="range range-50 range-sm-center range-md-left range-md-reverse range-md-middle">
                    <div class="cell-sm-10 cell-md-6 wow fadeInRight">
                        <div class="box-width-4 box-centered">
                            ...
                            <p>I will appreciate as many details about your particular wedding venue, dates, theme and
                                other aspects,
                                as you’d be willing to share. I will be giving you my feedback immediately!</p>
                        </div>
                    </div>
        ...
        <!-- Page Footer--><a class="section section-banner"
                ...
                <div class="range range-sm-center">
                    <div class="cell-sm-10 cell-md-8 cell-lg-6">
                        <!-- Brand--><a class="brand" href="index.html">
                            <div class="brand__name"><img src="images/logo-inverse-243x57.png" alt="" width="243"
                                    height="57" />
                            </div>
                        </a>
                        <!-- RD Mailform-->
                        <form class="rd-mailform form_inline" data-form-output="form-output-global"
                            data-form-type="subscribe" method="post" action="bat/rd-mailform.php">
                            <div class="form__inner">
                                <div class="form-wrap">
                                    <input class="form-input" id="subscribe-form-footer-email" type="email" name="email"
                                        data-constraints="@Email @Required">
